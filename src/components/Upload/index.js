...
const Component = props => {
  ...
  const { multiple, sizes: elementSizes = [] } = elementAttributes || {}
...
const UploadResult = ({
  ...
  const { host = defaultHost } = attributes || {}
  const value = model[name] && host + model[name]
  return (
    <Text
...
export { config, transform, UploadResult as result, icon }
